            ...
            <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-8">
                            <div class="input-group">
                                <select required class="js-example-basic-single form-control" style="width: 100%" name="game"
                                        id="games">
                ...
                <form method="post" action="{{ route('searchUsersRanking') }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-8">
                            <div class="input-group">
                                <select required class="js-example-basic-multiple form-control" style="width: 100%" name="users[]"
